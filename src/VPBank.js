...
class VPBank extends React.Component {
    render() {
        return (
            <div>
                <div><b style={{fontSize: 19}}>{this.props.stt}. Frontend Developer at Vietnam Prosperity Bank</b> <i>(2017
                    - 07/2019)</i>
                </div>
                <div style={{paddingLeft: 10}}>
                    ...
                    <ul style={{marginBottom: 6}}>
                        <li>Work with Project Owner and Designer to finalize the designs for User App and Administration
                            App
                        </li>
